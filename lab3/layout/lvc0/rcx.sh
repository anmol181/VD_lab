#!/bin/ksh
# This script was generated Wed Sep  9 19:35:14 2026 by:
#
...
#	/home/u24ev052/vd/lab3/layout/lvs0.xcn -assura_run_dir \
#	/home/u24ev052/vd/lab3/layout -assura_run_name lvs0 -rcxdir \
#	/home/u24ev052/vd/lab3/layout/lvc0 -xy_coordinates c,r -type full \
#	-temperature 25.0 -tempdir \
#	/home/u24ev052/vd/lab3/layout/lvc0/rcx_temp -sub_node_char # \
...
#	/home/u24ev052/vd/lab3/layout/lvc0/extview.tmp -net_name_space layout \
...
##AGDS_TEXT_LAYERS=
##ARRAY_VIAS_SPACING=
##ASSURA_RUN_DIR=/home/u24ev052/vd/lab3/layout
...
##NETS_FILE=/dev/null
##OUTPUT=/home/u24ev052/vd/lab3/layout/lvc0/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/u24ev052/vd/lab3/layout/lvc0
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/u24ev052/vd/lab3/layout/lvc0/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/u24ev052/vd/lab3/layout/lvc0/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/u24ev052/vd/lab3/layout/lvc0
...
/home/u24ev052/vd/lab3/layout/lvs0.xcn
ENDCAT
...
export GOALIE2DIR
vdbToRcx /home/u24ev052/vd/lab3/layout lvs0 -unit meters -- -V1 -H satfile -r \
	/home/u24ev052/vd/lab3/layout/lvs0.xcn -df2 -xgl
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -cgnd ${CAP_GROUND},1.0 -sc \
	...
	- NET - /home/u24ev052/vd/lab3/layout/lvc0/extview.tmp
